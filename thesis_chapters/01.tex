...
%         &=B\frac{4\pi^2m_a}{p_{a\rightarrow b\vert c}}\times\frac{4\pi}{(2\pi)^4}\tilde{q}^{\perp,2}\times\int_0^\infty\dt t\int_{-1}^1\dt v\;\Big(\omega_{\vec{q}}\frac{\dt N_a}{\dt^3 q}\Big)\Big\vert_{t\cdot \tilde{q}^\perp }\frac{\Theta(u^\star-1)}{\sqrt{(u^\star)^2-1}}\frac{1}{\sqrt{1-v^2}}\frac{\sigma(t,v)}{\vert\vec{\nabla}g\vert(t,u^\star,v)}
%     \end{align}
% \end{subequations}
...
%    \text{and}\qquad q^\perp=\tilde{q}^\perp t\quad\text{with}\;\tilde{q}^\perp=\const
% \end{gather*}
...
\begin{subequations}
    ...
    \end{align}
\end{subequations}
% Using $q^\perp\mapsto t\cdot \tilde{q}^\perp$, where $\tilde{q}^\perp=\const$ carries the dimension and $t\in[0,\infty)$ is dimensionless, we calculate
% \begin{subequations}
%     \begin{align}
%         \omega_{\vec{p}}\frac{\dt N_b}{\dt^3p}&=B\frac{4\pi^2m_a}{p_{a\rightarrow b\vert c}}\times\frac{4\pi}{(2\pi)^4}\int_{(0,0,0)}^{(\infty,\infty,\pi)}\dt q^\perp\dt\eta_q\dt\varphi_q\cdot q^\perp\cdot \Big(\omega_{\vec{q}}\frac{\dt N_a}{\dt^3 q}\Big)\Big\vert_{t\cdot q^\perp}\times\nonumber\\
%         &\phantom{=}\qquad\times\delta\big(-\omega_q^\perp \omega_p^\perp\cosh\eta_q+q^\perp p^\perp\cos\varphi_q+m_a E_{a\rightarrow b\vert c}\big)\\
%         &=\const\times\int_0^\infty\dt t\int_0^\pi\dt\varphi\cdot t\cdot \Big(\omega_{\vec{q}}\frac{\dt N_a}{\dt^3 q}\Big)\Big\vert_{t\cdot q^\perp}\frac{\sigma(t,\varphi)}{\vert\vec{\nabla}g(t,\eta^\star,\varphi)\vert}
%     \end{align}
% \end{subequations}
Here we defined
\begin{subequations}
