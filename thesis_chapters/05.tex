...
To restrict initial data further in a physically meaningful way, from the fluid theory we could try to prescribe the energy density of the hypothetical superfluid
%%%% MORE DETAIL
%%%% MORE DETAIL
%%%% MORE DETAIL
% \begin{subequations}
...
% By means of the underlying assumption of parallelity of all gradients with the 4-velocity $u_\mu$, its conservation law reads
% \begin{equation}
...
Let us investigate the possibility of an evolution process where the condensate density, i.e. the field amplitudes, rise during the fireball evolution with an easy-to-model ${(\tau,r)}$-dependence. To do so, consider a real field that depends on Bjorken time only and increases in amplitude during the fireball evolution, starting at $\tau_0$.  Such a field may have the form 
\begin{equation}
    ...
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_constfield_20240822_161734_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_constfield_20240822_161734_masses_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_constfield_20240822_161734_masses_spec.png}        
            \end{minipage}
        }
    \end{minipage}
}
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240822_135426_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240822_135426_spec.png}        
            \end{minipage}
        }
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143119_m226_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143119_m226_spec.png}        
            \end{minipage}
        }
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143151_m398_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143224_m570_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143224_m570_spec.png}        
            \end{minipage}
        }
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143253_m742_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143326_m914_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143326_m914_spec.png}        
            \end{minipage}
        }
...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.4\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/spectra_real_consteps_20240826_143341_m1000_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.4\linewidth}
...
\subsection{Type C - Time Dependent Condensate}
    ...
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.45\linewidth}
                \centering
                \includegraphics[width=\linewidth]{./../MasterThesis_HeavyIonCollisions/code/C++/DCCspec/images/spectra_real_m140_taudep_20241029_132506_init.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.45\linewidth}
                \centering
                \includegraphics[width=\linewidth]{./../MasterThesis_HeavyIonCollisions/code/C++/DCCspec/images/spectra_real_m140_taudep_20241029_132506_spec.png}        
            \end{minipage}
        }
        \captionof{figure}{Initial conditions (left)  and resulting spectra (right) for different growth rates of a $\tau$-dependent condensate ${\varphi\propto(\tau-\tau_0)^a}$, using $m_\pi=0.14\,\text{GeV}$.}
        \label{fig:SpecRealTauDep_m140}
    \end{minipage}
}

\subsection{Observations}

This paragraph aims to summarize the insights obtained from the last sections. All of the investigated families of initial conditions leave essentially 1 parameter and the particle mass open to variation. We found that not only the precise parameter choice has little influence on the resulting spectrum, but also the type of initial conditions plays no significant role for the shape of the spectrum. An exception from this statement is the large $p_T$-behaviour of some graphs, especially for the case of larger particle mass in Type B initial conditions. However, since we are only interested in the low $p_T$-regime anyways these differences do not affect our conclusion too much. In the low $p_T$ range of interest we denote a universal shape w.r.t. the variations under investigation. This universality is not to be understood in terms of statistical systems at criticality, but suggests a certain physical reality of the observed phenomenon, as it is not subject to an unnatural amount of fine tuning. We shall characterize the shape of the DCC spectra in terms of a few simple properties:
\begin{enumerate}
...
% \begin{subequations}
%     \begin{align}
%         J(\pm p)&=2\pi^2\mathcal{T}\int_0^\frac{\mathcal{R}}{r_{\text{dim}}}\dt\alpha r\Bigg[r_{\text{dim}}B\Big[J_0(r p_T)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
%         &\phantom{=}+ A\Big[r_{\text{dim}}\times J_0(r p_T)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]\\\
%         &=2\pi^2\mathcal{T}\int_0^\mathcal{R}\dt rr\Bigg[B\Big[J_0(r p_T)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
%         &\phantom{=}+ A\Big[J_0(r p_T)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]\\
%         &=2\pi^2\mathcal{T}\frac{1}{p_T^2}\int_0^{\mathcal{R}p_T}\dt tt\Bigg[B\Big[J_0(t)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
%         &\phantom{=}+ A\Big[J_0(t)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]
%     \end{align}
% \end{subequations}
