...
The starting point for this study is formula \eqref{eq:SpectrumFinalFormula} to compute the spectrum from the condensate field and derivative on the freezeout surface. To make an analytical treatment possible, we simplify the freezeout geometry and consider the freezeout surface to be composed of a section where $\tau=\const$ and a section where $r=\const$ and the fireball shall be contained within a rectangular region ${[0,\mathcal{T}]\times[0,\mathcal{R}]}$ in the ${\tau-r}$-plane Further it can be expected that the relevant part of the spectrum originates from the low wavelength modes of the field, thus we start again with the assumption of constant field and orthogonal derivative.

Start with the portion of the simplified freezeout surface where $\tau\equiv\mathcal{T}=\const$ and some parametrization ${r(\alpha)}$ with the inverse being a function ${\alpha(r)}$. Restricting the fireball radius to $\mathcal{R}$, the integration domain of $\alpha$ is restricted to ${[0,\alpha(\mathcal{R})]}$. Denote the constant value of $\phi$ by $A$ and its orthogonal derivative $\partial_\tau\phi$ by $B$. Note that this is a notion  Use
\begin{equation}
    \int_0^{\alpha(\mathcal{R})}\dt\alpha r^\prime r=\int_0^\mathcal{R}\dt rr=\frac{1}{p_T^2}\int_0^{\mathcal{R}p_T}\dt tt
\end{equation}
for ${t=rp_T}$.
...
\begin{subequations}
    \begin{align}
        J_{\tau=\mathcal{T}}(\pm p)&=2\pi^2\mathcal{T}\int_0^{\alpha(\mathcal{R})}\dt\alpha r\Bigg[r^\prime B\Big[J_0(r p_T)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
        &\phantom{=}+ A\Big[r^\prime\times J_0(r p_T)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]\\\
        &=2\pi^2\mathcal{T}\int_0^\mathcal{R}\dt rr\Bigg[B\Big[J_0(r p_T)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
        &\phantom{=}+ A\Big[J_0(r p_T)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]\\
        &=2\pi^2\mathcal{T}\frac{1}{p_T^2}\int_0^{\mathcal{R}p_T}\dt tt\Bigg[B\Big[J_0(t)\times\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)\Big]+\nonumber                                                                                             \\
        &\phantom{=}+ A\Big[J_0(t)\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Big]\Bigg]
...
\begin{equation}
    \int\dt xx^{\nu+1}\mathscr{C}_\nu(x)=x^{\nu+1}\mathscr{C}_{\nu+1}(x)
\end{equation}
for ${\mathscr{C}_\nu=J_\nu,\,Y_\nu}$ we find the contributions
\begin{equation}
    J_{\tau=\mathcal{T}}(\pm p)=2\pi^2\frac{\mathcal{T}\mathcal{R}}{p_T}\Bigg[B\big(-Y_0(\mathcal{T}\omega_T)\pm\imagu J_0(\mathcal{T}\omega_T)\big)+A\times\omega_T\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\Bigg]J_1(\mathcal{R}p_T)\,.
\end{equation}
An analogous computation is performed for the case ${r=\mathcal{R}=\const}$ and yields
\begin{equation}
    J_{r=\mathcal{R}}(\pm p)=2\pi^2\frac{\mathcal{T}\mathcal{R}}{\omega_T}\Bigg[BJ_0(\mathcal{R}p_T)+A\times p_TJ_1(\mathcal{R}p_T)\Bigg]\big(-Y_1(\mathcal{T}\omega_T)\pm\imagu J_1(\mathcal{T}\omega_T)\big)\,.
\end{equation}