...
\end{equation}
We will denote the contributions from each integral by $J_{\mathcal{T}}$ and ${J_{\mathcal{R}}}$ respecitvely.
...
\begin{equation}
    \int\dt tt^{\nu+1}\mathscr{C}_\nu(t)=t^{\nu+1}\mathscr{C}_{\nu+1}(t)
\end{equation}
for the Besselfunctions ${\mathscr{C}_\nu=J_\nu,\,Y_\nu}$ we find the contribution
\begin{equation}
...
\end{multline}
The spectrum can now be calculated from the sum ${J(\pm p)=J_{\mathcal{T}}(\pm p)+J_{\mathcal{R}}(\pm p)}$ and leaves the 6 parameters ${\mathcal{T},\mathcal{R},A_{\mathcal{T}},B_{\mathcal{T}},A_{\mathcal{R}},B_{\mathcal{R}}}$ open to be tuned.