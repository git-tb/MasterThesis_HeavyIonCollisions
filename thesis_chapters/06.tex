...
A useful and simple parametrization in the proximity of thresholds, in the context of the $\sigma\pi\pi$-interaction is given by \cite{GiacosaEtAl_2021}
\begin{equation}
...
\end{equation}
and we shall interprete it as a probability distribution, weighing the spectra computed from the decay ${\sigma\to\pi\pi}$ for different masses $m_\sigma=\mu$.