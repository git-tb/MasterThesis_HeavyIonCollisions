...
\debugbox{
    \begin{minipage}{\linewidth}
        ...
        \debugbox{
            \begin{minipage}{0.45\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/decay_sigmaresonance_pi_m140_decayspecs.png}        
            \end{minipage}
        }
        \debugbox{
            \begin{minipage}{0.45\linewidth}
                \centering
                \includegraphics[width=\linewidth]{code/C++/DCCspec/images/decay_sigmaresonance_pi_m140_decayspec_weighted.png}        
            \end{minipage}
        }
        \captionof{figure}{.}
        \label{fig:decayspec_inittest}
