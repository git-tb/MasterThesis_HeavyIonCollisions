...
\begin{gather}
    \frac{\partial x^i}{\partial t}
        ...
        =\begin{pmatrix}
            1\\
            v\frac{p_T Q}{\omega_{p,T}\omega_{q,T}}-\frac{t(Q)^2(m_a E^a_{b\vert c}+Q p_T tv)}{(\omega_{q,T})^3\omega_{p,T}}\\
            0
        \end{pmatrix}
        =\begin{pmatrix}
            1\\
...
\vspace{3em}
\begin{equation}
    \eqnmarkbox[blue]{myeq}{\omega_{\vec{p}}\frac{\dt N_b}{\dt^3p}=\frac{B(Q)^2}{p^a_{b\vert c}\pi}\int_0^\infty\dt t\int_{-1}^1\dt v\;t\;\Big(\omega_{\vec{q}}\frac{\dt N_a}{\dt^3 q}\Big)\Big\vert_{t\cdot Q }\Bigg(\frac{\Theta(u-1)}{\sqrt{u^2-1}}\frac{1}{\sqrt{1-v^2}}\frac{\sigma(t,v)}{\Vert\vec{\nabla}g(t,u,v)\Vert}\Bigg)\Bigg\vert_{u=u^\star(t,v)}}
\end{equation}
