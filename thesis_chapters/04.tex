...
\end{equation}
The Lorentz invariant formulation of this identity, compare equations \eqref{eq:NumberDensity} and \eqref{eq:SpectraConversion}, reads
\begin{equation}
    \frac{1}{2\pi p_T}\frac{\dt N}{\dt p_T\dt\eta_p}=\frac{1}{(2\pi)^3}\frac{\vert J(p)\vert^2}{2}\,.
\end{equation}
...
\end{equation}
This equation of course contains the case of real fields.
